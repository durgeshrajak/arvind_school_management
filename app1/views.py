...
def add_school(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            school.remaining_amount = school.payable_amount - school.paid_amount
            school.save()
...
def edit_school(request, pk):
    school = get_object_or_404(SchoolData, pk=pk)
    if request.method == 'POST':
    ...
    return render(request, 'edit_school.html', {'form': form})
